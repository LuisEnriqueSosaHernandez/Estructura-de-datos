    ...
    public static void main(String[] args) throws IOException {
       ...
       try{
            ...
            switch (opcion) {
                ...
                case 2: {
                    if (!ls.LSLVacia()) {
                        System.out.print("\n Inserte el titulo como referencia\t");
                        dato1 = Leer.nextLine();
                ...
                case 6: {
                    if (!ls.LSLVacia()) {
                        System.out.println("Ingrese la referencia. El titulo despues de esta referencia se eliminara: ");
                        dato = Leer.nextLine();
                ...
                case 7: {
                    if (!ls.LSLVacia()) {
                        System.out.println("Ingrese el titulo de referencia a eliminar:\t");
                        dato = Leer.nextLine();
                        ls.retirar(dato);
                    } else {
                        System.out.println("Esta lista no tiene nodos");
